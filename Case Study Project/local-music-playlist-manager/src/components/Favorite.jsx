...
const Favorites = ({ tracks = [], currentTrackId, onSelectTrack, onDeleteTrack, onToggleFavorite, onAddToPlaylist }) => {
    ...
    return (
        <Box sx={{ width: "100%", color: "#FFF", mb: 3 }}>
            ...
            {favoriteTracks.length === 0 ? (
                ...
                <LibrarySite tracks={favoriteTracks} currentTrackId={currentTrackId} onSelectTrack={onSelectTrack} onDeleteTrack={onDeleteTrack} onToggleFavorite={onToggleFavorite} onAddToPlaylist={onAddToPlaylist} />
            )}
        </Box>
    );
};
